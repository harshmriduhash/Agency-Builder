...
export default function UserDetails({ id, type, userData, subAccounts }: Props) {
                ...
                <Select
                  ...
                  onValueChange={(value: Role) => {
                    if (value === "SUBACCOUNT_USER" || value === "SUBACCOUNT_GUEST") {
                      setRoleState("You need to have subaccounts to assign SubAccount access to the team members");
                    }
                    else setRoleState('');
                    ...
                    return (
                      ...
                      >
                        ...
                        <Switch
                          ...
                          onCheckedChange={(p) => {
                            onChangePermission(subAccount.id, p, subAccountPermissionsDetails?.id);
                          }}
                        />
                      </div>
                    )
