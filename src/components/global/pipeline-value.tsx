'use client';
import { getPipelineDetails, getPipelines } from "@/lib/queries";
...
const PipelineValue: React.FC<Props> = ({ subaccountId }) => {
    ...
    <Card className="relative w-full xl:w-[350px]">
      <CardHeader>
        ...
        <CardContent className="text-sm text-muted-foreground">
          <p className="mb-2">
            Total value of all the given pipeline except the last lane.
