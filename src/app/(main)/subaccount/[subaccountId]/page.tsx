...
import BadgeDeltaCustom from "@/components/global/badge-delta-custom";
...
const SubaccountIdPage: React.FC<Props> = async ({ params, searchParams }) => {
  let currency = 'USD'
  let sessions
  ...
  const funnelPerformanceMatrics = funnels.map((funnel) => ({
    ...funnel,
      ...
      <div className="relative h-full">
        ...
        <div className="flex flex-col gap-4 pb-6">
          ...
          <div className="flex gap-4 flex-col xl:!flex-row">
            <Card className="relative">
              ...
              <CardContent className=" text-sm text-muted-foreground flex flex-col gap-12 justify-between ">
                <SubaccountFunnelChart data={funnelPerformanceMatrics} />
          ...
          <div className="flex gap-4 xl:!flex-row flex-col">
            <Card className="p-4 flex-1 h-[450px] overflow-scroll invisible-scrollbar relative">
              <CardHeader>
